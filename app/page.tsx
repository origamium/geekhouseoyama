  ...
  return (
    <main className="p-8 font-[family-name:var(--font-geist-sans)]">
      ...
      <Section>
        ...
        <p className="text-lg text-muted-foreground">
          このアークリスプハウスは現在両親といっしょに住んでいますが、2024年内に両親が中国へ移住（帰国？）するため、ひとりものの独身には広すぎる家をどうしようかな〜と思っていたところ、シェアハウスやればいいじゃんと思い立って、雑に計画しているものです。
          (そのため両親の気が変わればこのシェアハウス計画は立ち消えになります)
          <br />
          家主となるアークリスプはこれまでいくつかのシェアハウスでの生活経験があり、その中でこうだったらなあとか、こうだったらいいなあとか、こういうのがあったらいいなあとか、そういうことを適用していこうというのを考えています。
          <br />
          小山市はあんまり何もありませんが、平和だし、静かだし、たまに東京に行ったりするにはわりと近くていいところです。
        </p>
      </Section>
      <Section>
        <h2 className="pb-4 text-2xl font-extrabold leading-tight tracking-tighter md:text-4xl">
